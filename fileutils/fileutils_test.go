...
// 	}
// 	syDir := os.TempDir() + "testReadSymlinkToExistingDirectory"
// 	var err error
// 	if err = os.Mkdir(syDir, 0777); err != nil {
// 		t.Errorf("failed to create directory: %s", err)
// 	}

// 	if err = os.Symlink(syDir, os.TempDir()+"dirLinkTest"); err != nil {
// 		t.Errorf("failed to create symlink: %s", err)
// 	}

// 	var path string
// 	if path, err = ReadSymlinkedDirectory(os.TempDir() + "dirLinkTest"); err != nil {
// 		t.Fatalf("failed to read symlink to directory: %s", err)
// 	}

// 	if path != syDir {
// 		t.Fatalf("symlink returned unexpected directory: %s, syDir: %s", path, syDir)
// 	}

// 	if err = os.Remove(os.TempDir() + "testReadSymlinkToExistingDirectory"); err != nil {
// 		t.Errorf("failed to remove temporary directory: %s", err)
// 	}

// 	if err = os.Remove(os.TempDir() + "dirLinkTest"); err != nil {
